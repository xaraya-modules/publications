...
class Publications_GlossaryBlock extends BasicBlock implements iBlock
{
    ...
    public function display()
    {
        ...
        $article = $this->mod()->apiMethod('publications', 'user', 'get', $articlecriteria);
        ...
        $this->setTitle(str_replace('{term}', \xarVarPrep::forDisplay($glossaryterm), $this->title));
    ...
    public function modify()
    {
        ...
        $vars['pubtypes'] = $this->mod()->apiMethod('publications', 'user', 'get_pubtypes');
