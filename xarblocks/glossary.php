...
class Publications_GlossaryBlock extends BasicBlock implements iBlock
{
    ...
    public function display()
    {
        ...
        $article = $this->mod()->apiMethod('publications', 'userapi', 'get', $articlecriteria);
        ...
        $this->setTitle(str_replace('{term}', $this->prep()->text($glossaryterm), $this->title));
    ...
    public function modify()
    {
        ...
        $vars['pubtypes'] = $this->mod()->apiMethod('publications', 'userapi', 'get_pubtypes');
