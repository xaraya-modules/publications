...
function publications_admin_display(array $args = [], $context = null)
{
    ...
    /*    if (empty($name) && empty($ptid)) return xarController::notFound(null, $context);
...
function publications_admin_highlights(array $args = [], $context = null)
{
    /*
